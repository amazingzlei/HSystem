$(function () {
    ...
    $.ajax(
        {
            url:urlPath+'/purchaseInfo/getReperstory',
            type:'GET',
...
function addReperstory() {
    ...
    if(null == position || position==''){
        toastr.error("请输入仓库位置!");
    }else{
        $.ajax({
            url:urlPath+"/purchaseInfo/addReperstory",
            type:"POST",
...
function deleteReperstory(obj) {
    ...
    swal({
        ...
        $.ajax({
            url:urlPath+"/purchaseInfo/deleteReperstory",
            type:"POST",
            data:{rid:rid},
            success:function (data) {
                if(data.code == 200){
...
function updateReperstory() {
    ...
    if(null == position || position==''){
        ...
        $.ajax({
            url:urlPath+"/purchaseInfo/updateReperstory",
            type:"POST",
