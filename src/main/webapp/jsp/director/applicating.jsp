        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    <li><a href="<%=path%>/directorInfo/getView/director"><i
                    ...
                    <li><a href="<%=path%>/directorInfo/getView/applicating"  class="active"><i
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        采购列表
                        <button type="button" class="btn btn-info" style="margin-left: 81%;font-size: 12px" onclick="subPurchase()">提交申请</button>
                    </div>
...
<script type="text/javascript" src="<%=path%>/js/director/applicating.js"></script>
<%--<script type="text/javascript" src="<%=path%>/js/director/myapplication.js"></script>--%>
