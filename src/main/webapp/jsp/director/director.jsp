...
<div id="wrapper">
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    <li><a href="<%=path%>/directorInfo/getView/director" class="active"><i
                            class="fa fa-edit fa-fw"></i> 药品采购</a></li>
                    ...
                    <li><a href="<%=path%>/directorInfo/getView/count"><i
                            class="fa fa-indent fa-fw"></i> 出药统计</a></li>
                    <li><a href="<%=path%>/directorInfo/getView/draw"><i
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <button type="button" class="btn btn-primary" onclick="getExpireMed(this)">查看即将过期</button>
                <button type="button" class="btn btn-info" onclick="getBlowCount(this)">查看库存不足</button>
                <button type="button" class="btn btn-info" onclick="addNewMed(this)">添加新药</button>
                <%--<input id="medFun" type="text"><button type="button" class="btn btn-info" onclick="searchMed(this)">查询</button>--%>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
...
<div class="modal fade" id="customerEditDialog" tabindex="-1" role="dialog"
     aria-labelledby="myModalLabel" style="margin: 0 auto">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">采购药品</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal" id="addPurchase">
                    <input type="hidden" id="edit_wid" name="wid"/>
                    <div class="form-group">
                        <label for="medName" class="col-sm-2 control-label">药品名</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control"  style="width: 300px;display: inline-block" id="medName" placeholder="姓名"
                                   name="medName" disabled>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">数量</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="medNum" name="medNum" style="width: 300px;display: inline-block" required>
                        </div>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
                ...
                <input type="submit" class="btn btn-primary" onclick="doSub()"/>
            </div>
        </div>
    </div>
</div>
...
<%--采购新药--%>
<div class="modal fade" id="addNewMedDialog" tabindex="-1" role="dialog"
     aria-labelledby="myModalLabel" style="margin: 0 auto">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">采购新药</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal" id="addNewMedPurchase">
                    <div class="form-group">
                        <label for="medName" class="col-sm-2 control-label">药品名</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control"  style="width: 300px;display: inline-block" id="newMedName" placeholder="药品名"
                                   name="newMedName">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">数量</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="newMedNum" name="newMedNum" style="width: 300px;display: inline-block" required>
                        </div>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
                <input type="submit" class="btn btn-primary" onclick="doNewSub()"/>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript" src="<%=path%>/js/director/director.js"></script>
...
<script type="text/javascript" src="<%=path%>/js/validate/validate-methods.js"></script>
