        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li><a href="<%=path%>/directorInfo/getView/myapplication" class="active"><i
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <%--<div style="display: inline-block;margin-left: 95%">--%>
                            <a href="<%=path%>/directorInfo/getView/myapplication" class="btn btn-info" style="font-size: 12px;margin-left: 92.3%">返回</a>
                        <%--</div>--%>
                    </div>
...
<script type="text/javascript" src="<%=path%>/js/director/applicationinfo.js"></script>
