...
<div id="wrapper">
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li><a href="<%=path%>/directorInfo/getView/count"   class="active"><i
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">出药统计</h1>
            </div>
        </div>
        <div id="echarts" style="height: 480px;"></div>
    </div>
...
<script type="text/javascript" src="<%=path%>/js/echarts/echarts-all.js"></script>
<script type="text/javascript" src="<%=path%>/js/director/count.js"></script>
