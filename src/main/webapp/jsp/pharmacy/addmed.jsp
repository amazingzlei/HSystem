        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li><a href="<%=path%>/pharmacyInfo/getView/addmed"  class="active"><i
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <%--<div style="display: inline-block;margin-left: 90%">--%>
                            <%--<a href="<%=path%>/pharmacyInfo/getView/pharmacy" class="btn btn-primary" style="font-size: 12px">返回</a>--%>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="title">添加药品</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal" id="addPurchase">
                    <input type="hidden" id="mid" name="mid"/>
                    <div class="form-group">
                        <label for="name" class="col-sm-2 control-label">药品名</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control"  style="width: 300px;display: inline-block" id="name" placeholder="药品名称"
                                   name="name" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="productTime" name="productTime" style="width: 300px;display: inline-block" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="medNum" name="counterLeft" style="width: 300px;display: inline-block">
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-sm-2 control-label">药台</label>
                        <div class="col-sm-10">
                            <select class="form-control" id="counterId" name="counterId" style="width: 300px"></select>
                        </div>
                    </div>
...
<script type="text/javascript" src="<%=path%>/js/pharmacy/addmed.js"></script>
