        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li><a href="<%=path%>/pharmacyInfo/getView/cancellation"  class="active"><i
...
<script type="text/javascript" src="<%=path%>/js/pharmacy/cancellation.js"></script>
