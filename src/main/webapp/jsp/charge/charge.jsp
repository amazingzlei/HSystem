            ...
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    <li><a href="javascript:;" class="active"><i
                            class="fa fa-edit fa-fw"></i> 药方收费</a></li>
                </ul>
            </div>
        </div>
                ...
                <ul class="nav">
                    <li class="sidebar-search">
                        <div class="input-group custom-search-form">
                            <input type="text" class="form-control" id="searchContent" style="width: 300px" placeholder="请输入药方编号...">
                            <span class="input-group-btn" style="float: left">
                                    <button class="btn btn-default" type="button" onclick="searchPrescript(this)">
...
<script type="text/javascript" src="<%=path%>/js/charge/charge.js"></script>
