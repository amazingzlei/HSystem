...
<div id="wrapper">
            ...
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li><a href="<%=path%>/manageEmployeeInfo/insertEmployee" ><i
                        ...
                        <li><a href="<%=path%>/manageEmployeeInfo/insertDepart" class="active"><i
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">添加科室</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
        <form action="<%=path%>/manageEmployeeInfo/addDepart"
              method="post" id="addDepart">
            <div class="form-group">
                <label for="edit_name" class="col-sm-2 control-label">科室名称</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="edit_name" placeholder="科室名称" name="name">
                </div>
            </div>
...
<script type="text/javascript">
    ...
    function doSub() {
        if(isNameLegal($("#edit_name").val())){
           $.ajax({
               url:"<%=path%>/manageEmployeeInfo/addDepart",
               type:'get',
               dataType:'json',
               data:$("#addDepart").serialize(),
