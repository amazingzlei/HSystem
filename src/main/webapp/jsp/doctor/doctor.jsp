...
<head>
    ...
    <link href="<%=path%>/css/doctor/doctor.css" rel="stylesheet" type="text/css"/>
...
<div id="wrapper">
            ...
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    <li><a href="javascript:;" class="active"><i
                            class="fa fa-edit fa-fw"></i> 开具药方</a></li>
                </ul>
            </div>
        </div>
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <span>搜索:</span>
                <input type="text" data-provide="typeahead" id="search-platform" placeHolder="请输入药名" autocomplete="off">
                <button type="button" class="btn btn-primary" style="margin-left: 50px" onclick="subDtn()">提交药方</button>
            </div>
        </div>
        <div class="row" id="method">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">药方明细</div>
...
<script type="text/javascript" src="<%=path%>/js/bootstrap/bootstrap3-typeahead.min.js"></script>
<script type="text/javascript" src="<%=path%>/js/doctor/doctor.js"></script>
