        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    <li><a href="<%=path%>/purchaseInfo/getView/purchase"  class="active"><i
                            class="fa fa-edit fa-fw"></i> 采购订单</a></li>
                    <li><a href="<%=path%>/purchaseInfo/getView/repertory"><i
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <div style="display: inline-block;margin-left: 90%">
                            <a href="<%=path%>/purchaseInfo/getView/purchase" class="btn btn-primary" style="font-size: 12px">返回</a>
                            <a href="<%=path%>/purchaseInfo/purchaseExport?pid=${data}" class="btn btn-primary" style="font-size: 12px">导出</a>
                        </div>
                    </div>
...
<script type="text/javascript" src="<%=path%>/js/purchase/detail.js"></script>
