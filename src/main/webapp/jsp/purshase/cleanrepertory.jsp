        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li><a href="<%=path%>/purchaseInfo/getView/cleanrepertory" class="active"><i
...
<script type="text/javascript" src="<%=path%>/js/purchase/cleanrepertory.js"></script>
