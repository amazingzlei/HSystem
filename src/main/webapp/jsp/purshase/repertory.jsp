        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    <li><a href="<%=path%>/purchaseInfo/getView/purchase"><i
                            class="fa fa-edit fa-fw"></i> 采购订单</a></li>
                    <li><a href="<%=path%>/purchaseInfo/getView/repertory" class="active"><i
                            class="fa fa-edit fa-fw"></i> 仓库添加</a></li>
                    <li><a href="<%=path%>/purchaseInfo/getView/cleanrepertory"><i
                            class="fa fa-edit fa-fw"></i> 下架药品</a></li>
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="add_reperstory_form">
                    ...
                    <div class="form-group">
                        <label for="position" class="col-sm-2 control-label">仓库位置</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="position" placeholder="仓库位置"
                                   name="position">
                        </div>
                    </div>
                </form>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel1">修改仓库</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal" id="edit_repertory_form">
                    <input type="hidden" id="edit_rid" name="rid"/>
                    <div class="form-group">
                        <label for="edit_position" class="col-sm-2 control-label">仓库位置</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="edit_position" placeholder="仓库位置"
                                   name="position">
                        </div>
                    </div>
                </form>
...
<script type="text/javascript" src="<%=path%>/js/purchase/repertory.js"></script>
